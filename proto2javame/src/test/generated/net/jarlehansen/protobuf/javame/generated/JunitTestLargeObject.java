...
// Generated by proto2javame, Thu Aug 13 21:43:17 CEST 2009. DO NOT EDIT!
	...
	private static JunitTestLargeObject parseFields(final InputReader reader) throws IOException {
		...
		while (nextFieldNumber > 0) {
			...
			case fieldNumberIdList:
				builder.addElementIdList(new Integer(reader.readInt(nextFieldNumber)));
				break;
			case fieldNumberNumber2List:
				builder.addElementNumber2List(new Long(reader.readLong(nextFieldNumber)));
				break;
			case fieldNumberNameList:
				builder.addElementNameList(reader.readString(nextFieldNumber));
				break;
			case fieldNumberBoolValList:
				builder.addElementBoolValList(new Boolean(reader.readBoolean(nextFieldNumber)));
				break;
			case fieldNumberAmountList:
				builder.addElementAmountList(new Double(reader.readDouble(nextFieldNumber)));
				break;
			case fieldNumberFloatNumList:
				builder.addElementFloatNumList(new Float(reader.readFloat(nextFieldNumber)));
				break;
