...
// Generated by proto2javame, Fri Oct 08 19:28:52 CEST 2010.
	...
	static boolean populateBuilderWithField(final InputReader reader, final Builder builder, final int fieldNumber) throws IOException {
		...
		switch (fieldNumber) {
			...
			case fieldNumberEmployeeGoalComments:
				...
				boolean boolEmployeeGoalCommentJavaMe = true;
				int nestedFieldEmployeeGoalCommentJavaMe = -1;
				while(boolEmployeeGoalCommentJavaMe) {
					nestedFieldEmployeeGoalCommentJavaMe = getNextFieldNumber(reader);
					boolEmployeeGoalCommentJavaMe = EmployeeGoalCommentJavaMe.populateBuilderWithField(reader, builderEmployeeGoalComments, nestedFieldEmployeeGoalCommentJavaMe);
				}

				builder.addElementEmployeeGoalComments(builderEmployeeGoalComments.build());
				populateBuilderWithField(reader, builder, nestedFieldEmployeeGoalCommentJavaMe);
				break;
