...
// Generated by proto2javame, Fri Jul 10 23:09:12 CEST 2009. DO NOT EDIT!
...
public final class UpdatedIntegrationTestObject {
	...
	private UpdatedIntegrationTestObject(final Builder builder) {
		if (builder.hasId && builder.hasLongNumber && builder.hasBytesObject && builder.hasFloatObject && builder.hasAmount && builder.hasNewField && builder.hasNewField2 && builder.hasNewField3 && builder.hasNewField4 && builder.hasNewField5 && builder.hasNewField6 && builder.hasNewField7 ) {
			...
			throw new UninitializedMessageException("Not all required fields were included, " + 
				" id:" + builder.hasId + " longNumber:" + builder.hasLongNumber + " bytesObject:" + builder.hasBytesObject + " floatObject:" + builder.hasFloatObject + " amount:" + builder.hasAmount + " newField:" + builder.hasNewField + " newField2:" + builder.hasNewField2 + " newField3:" + builder.hasNewField3 + " newField4:" + builder.hasNewField4 + " newField5:" + builder.hasNewField5 + " newField6:" + builder.hasNewField6 + " newField7:" + builder.hasNewField7 + ", all fields that are false are mandatory but were not added");
		}
	}
	...
	private static UpdatedIntegrationTestObject parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = reader.getNextFieldNumber();
		final UpdatedIntegrationTestObject.Builder builder = new UpdatedIntegrationTestObject.Builder();
		...
		while (nextFieldNumber > 0) {
			...
			case fieldNumberNewField:
				builder.setNewField(reader.readByteString(nextFieldNumber));
				break;
			case fieldNumberNewField2:
				builder.setNewField2(reader.readInt(nextFieldNumber));
				break;
			case fieldNumberNewField3:
				builder.setNewField3(reader.readLong(nextFieldNumber));
				break;
			case fieldNumberNewField4:
				builder.setNewField4(reader.readString(nextFieldNumber));
				break;
			case fieldNumberNewField5:
				builder.setNewField5(reader.readFloat(nextFieldNumber));
				break;
			case fieldNumberNewField6:
				builder.setNewField6(reader.readBoolean(nextFieldNumber));
				break;
			case fieldNumberNewField7:
				builder.setNewField7(reader.readDouble(nextFieldNumber));
				break;
			default:
