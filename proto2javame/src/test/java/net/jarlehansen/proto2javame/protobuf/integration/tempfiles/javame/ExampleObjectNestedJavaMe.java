		...
		switch (fieldNumber) {
			...
			case fieldNumberIdentifier:
				...
				while(boolIdentifier) {
					nestedFieldIdentifier = getNextFieldNumber(reader);
					boolIdentifier = Identifier.populateBuilderWithField(reader, builderIdentifier, nestedFieldIdentifier);
				}

				builder.setIdentifier(builderIdentifier.build());
				populateBuilderWithField(reader, builder, nestedFieldIdentifier);
				break;
		default:
			fieldFound = false;
		}
