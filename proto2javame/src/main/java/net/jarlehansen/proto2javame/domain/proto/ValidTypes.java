...
public enum ValidTypes {
	DOUBLE("double", "double", "DATA_TYPE_DOUBLE", true),
	FLOAT("float", "float", "DATA_TYPE_FLOAT", true),
	INT32("int32", "int", "DATA_TYPE_INT", true, "Integer"),
	INT64("int64", "long", "DATA_TYPE_LONG", true),
	BOOL("bool", "boolean", "DATA_TYPE_BOOLEAN", true),
	...
	private ValidTypes(final String protoType, final String javaType, final String dataTypeConstant, final boolean primitiveType) {
        ...
        javaObjectType = JavaSourceCodeUtil.createCapitalLetterName(javaType);
	}
