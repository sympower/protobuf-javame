...
// Generated by proto2javame, Fri Oct 08 19:05:32 CEST 2010.
	...
	static boolean populateBuilderWithField(final InputReader reader, final Builder builder, final int fieldNumber) throws IOException {
		...
		switch (fieldNumber) {
			...
			case fieldNumberAddress:
				...
				while(boolAddress) {
					nestedFieldAddress = getNextFieldNumber(reader);
					boolAddress = Address.populateBuilderWithField(reader, builderAddress, nestedFieldAddress);
				}

				builder.setAddress(builderAddress.build());
				populateBuilderWithField(reader, builder, nestedFieldAddress);
				break;
		default:
			fieldFound = false;
		}
