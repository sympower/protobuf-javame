...
public final class Person extends AbstractOutputWriter {
	...
	static Person parseFields(final InputReader reader) throws IOException {
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		Person.unknownTagHandler = unknownTagHandler;
	}

	public static Person parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static Person parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static Person parseDelimitedFrom(final InputStream inputStream) throws IOException {
