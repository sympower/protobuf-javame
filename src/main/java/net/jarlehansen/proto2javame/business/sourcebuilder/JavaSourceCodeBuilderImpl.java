...
public final class JavaSourceCodeBuilderImpl implements JavaSourceCodeBuilder {
	...
	private final PrivateMethodsBuilder privateMethodsBuilder;
	...
	public JavaFileOutput createJavaSourceCode(final ProtoFileInput protoInput) {
		...
		javaOutput.setPrivateMethods(privateMethodsBuilder.createPrivateMethods(javaOutput.getClassName(), protoInput));
