...
public final class JunitTestObject {
	...
	public String toString() {
		...
		if(hasBoolObj) {
			retValue += "boolObj = " + this.boolObj + TAB;
		}
	...
	private byte[] createByteArray() {
		...
		if(hasBoolObj) {
			totalSize += ComputeSizeUtil.computeBooleanSize(fieldNumberBoolObj, boolObj);
		}
	...
	private void writeFields(final OutputWriter writer) throws IOException {
		...
		if(hasBoolObj) {
			writer.writeBoolean(fieldNumberBoolObj, boolObj);
		}
