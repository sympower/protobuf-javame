...
// Generated by proto2javame, Fri Aug 28 00:17:47 PDT 2009. DO NOT EDIT!
...
public final class ListTestObject extends AbstractOutputWriter {
	...
	protected int computeSize() {
		int totalSize = 0;
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberOne, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_INT, one);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberTwo, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_LONG, two);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberThree, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_DOUBLE, three);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberFour, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_STRING, four);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberFive, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_BYTESTRING, five);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberSix, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_FLOAT, six);
		totalSize += ComputeSizeUtil.computeListSize(fieldNumberSeven, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_BOOLEAN, seven);
	...
	protected void writeFields(final OutputWriter writer) throws IOException {
		writer.writeList(fieldNumberOne, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_INT, one);
		writer.writeList(fieldNumberTwo, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_LONG, two);
		writer.writeList(fieldNumberThree, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_DOUBLE, three);
		writer.writeList(fieldNumberFour, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_STRING, four);
		writer.writeList(fieldNumberFive, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_BYTESTRING, five);
		writer.writeList(fieldNumberSix, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_FLOAT, six);
		writer.writeList(fieldNumberSeven, net.jarlehansen.protobuf.javame.util.SupportedDataTypes.DATA_TYPE_BOOLEAN, seven);
		writer.writeData();
	}

	private static ListTestObject parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = reader.getNextFieldNumber();
		final ListTestObject.Builder builder = new ListTestObject.Builder();

		while (nextFieldNumber > 0) {
			switch (nextFieldNumber) {
			case fieldNumberOne:
				builder.addElementOne(reader.readInt(nextFieldNumber));
				break;
			case fieldNumberTwo:
				builder.addElementTwo(reader.readLong(nextFieldNumber));
				break;
			case fieldNumberThree:
				builder.addElementThree(reader.readDouble(nextFieldNumber));
				break;
			case fieldNumberFour:
				builder.addElementFour(reader.readString(nextFieldNumber));
				break;
			case fieldNumberFive:
				builder.addElementFive(reader.readByteString(nextFieldNumber));
				break;
			case fieldNumberSix:
				builder.addElementSix(reader.readFloat(nextFieldNumber));
				break;
			case fieldNumberSeven:
				builder.addElementSeven(reader.readBoolean(nextFieldNumber));
				break;
			default:
