...
public class GeneratedJavaMeObjectTest {
	...
	@Test
	public void testWriteDelimitedToOutputStream() throws IOException {
		final OutputStream out = mock(OutputStream.class);
	...
	public void testUninitializedMessage() {
		// Building object without adding the required fields should throw an Exception
		JunitTestObject.newBuilder().build();
	}
}
