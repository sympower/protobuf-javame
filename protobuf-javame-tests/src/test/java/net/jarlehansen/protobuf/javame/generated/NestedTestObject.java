...
// Generated by proto2javame, Wed Feb 23 17:06:06 CET 2011.
			...
			case fieldNumberNumber:
				...
				for(int i = 0 ; i < vcNumber.size(); i++) {
					...
					while(boolNumber) {
						...
						boolNumber = NumberTestObject.populateBuilderWithField(innerInputReader, builderNumber, nestedFieldNumber);
					}
					eachBinData = null;
